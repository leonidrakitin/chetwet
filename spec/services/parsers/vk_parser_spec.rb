...
require Rails.root.join('app/services/parsers/vk_parser').to_s

RSpec.describe VkParser do
  let(:parser) { described_class.new }
  let(:fixture_path) { Rails.root.join('spec/fixtures/files/vk_export_sample.json') }
