    ...
    <div class="flex flex-col gap-6 divide-y divide-n-strong">
      <div class="flex flex-col gap-6">
        <div class="flex flex-col gap-2 ltr:pr-10 rtl:pl-10">
          ...
          <p class="mb-0 text-sm text-n-text-display">
            {{
              t(
        ...
        <div class="flex items-center gap-3 w-full">
          <span
            class="min-h-10 px-3 py-2.5 inline-flex items-center w-full text-sm bg-transparent border rounded-lg text-n-text-body border-n-border-glass"
          >
            {{ subdomainCNAME }}
          </span>
          <NextButton
