...
<template>
  <div class="flex flex-col w-full gap-4">
    ...
    <div class="flex flex-col w-full gap-4">
      ...
      >
        <label
          class="text-sm font-medium whitespace-nowrap py-2.5 text-n-text-display"
        >
      ...
      >
        <label
          class="text-sm font-medium whitespace-nowrap text-n-text-display py-2.5"
        >
      ...
      >
        ...
        <ComboBox
          ...
          "
          class="[&>div>button:not(.focused)]:!outline-n-border-glass-soft"
        />
      </div>
      <div
        class="grid items-start justify-between w-full gap-2 grid-cols-[200px,1fr]"
