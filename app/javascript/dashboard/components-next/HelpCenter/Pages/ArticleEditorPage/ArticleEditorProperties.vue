...
<template>
  <div
    class="flex flex-col absolute w-[25rem] bg-n-alpha-3 outline outline-1 outline-n-border-glass-soft backdrop-blur-[100px] shadow-lg gap-6 rounded-xl p-6"
  >
    ...
    <div class="flex flex-col gap-2">
      <div>
        <div class="flex justify-between w-full gap-4 py-2">
          <label
            class="text-sm font-medium whitespace-nowrap min-w-[6.25rem] text-n-text-display"
          >
            {{
              t(
        ...
        <div class="flex justify-between w-full gap-3 py-2">
          <label
            class="text-sm font-medium whitespace-nowrap min-w-[7.5rem] text-n-text-display"
          >
            {{
