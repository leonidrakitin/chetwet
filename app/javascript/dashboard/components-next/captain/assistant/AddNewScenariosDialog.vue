...
<template>
  ...
  >
    ...
    <div
      v-if="showPopover"
      class="w-[31.25rem] absolute top-10 ltr:left-0 rtl:right-0 bg-n-alpha-3 backdrop-blur-[100px] p-6 rounded-xl border border-n-border-glass-soft shadow-md flex flex-col gap-6 z-50"
    >
