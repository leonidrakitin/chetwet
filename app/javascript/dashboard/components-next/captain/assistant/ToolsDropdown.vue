...
<template>
  <div
    ...
    class="w-[22.5rem] p-2 flex flex-col gap-1 z-50 absolute rounded-xl bg-n-alpha-3 shadow outline outline-1 outline-n-border-glass-soft backdrop-blur-[50px] max-h-[20rem] overflow-y-auto"
  >
    <div
    ...
    >
      ...
      <span class="text-n-text-body text-sm">{{ tool.description }}</span>
    </div>
  </div>
</template>
