...
<template>
  <div
    class="flex items-start xl:items-center flex-col md:flex-row gap-4 lg:gap-3 bg-n-glass-soft p-4 outline outline-1 outline-n-border-glass-soft rounded-xl"
  >
