...
<template>
  <div
    ...
    class="z-40 max-w-3xl min-w-96 lg:w-[750px] overflow-visible w-full border border-n-border-glass-soft bg-n-alpha-3 backdrop-blur-[100px] shadow-lg rounded-xl p-6 grid gap-6"
  >
    <h3 class="text-base font-medium leading-6 text-n-text-display">
      {{ filterModalHeaderTitle }}
    </h3>
    <div v-if="props.isSegmentView">
      <div class="pb-6 border-b border-n-border-glass-soft">
        <Input
