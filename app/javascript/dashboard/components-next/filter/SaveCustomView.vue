...
<template>
  <div
    ...
    class="z-40 max-w-3xl lg:w-[500px] overflow-visible w-full border border-n-border-glass-soft bg-n-alpha-3 backdrop-blur-[100px] shadow-lg rounded-xl p-6 grid gap-6"
  >
