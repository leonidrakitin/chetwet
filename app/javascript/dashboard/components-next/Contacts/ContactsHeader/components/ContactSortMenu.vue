...
<template>
  <div class="relative">
    ...
    <div
      ...
      class="absolute top-full mt-1 ltr:-right-32 rtl:-left-32 sm:ltr:right-0 sm:rtl:left-0 flex flex-col gap-4 bg-n-alpha-3 backdrop-blur-[100px] border border-n-border-glass-soft w-72 rounded-xl p-4"
    >
