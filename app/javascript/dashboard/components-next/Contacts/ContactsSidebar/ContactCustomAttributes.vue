...
<template>
  <div v-if="hasContactAttributes" class="flex flex-col gap-6 px-6 py-6">
    ...
    <div v-if="!hasNoUnusedAttributes" class="flex items-center gap-3">
      ...
      <span class="text-sm font-medium text-n-text-body/60">{{
    ...
    <div class="flex flex-col gap-3">
      <div v-if="!hasNoUnusedAttributes" class="relative">
        ...
        <input
          ...
          "
          class="w-full h-8 py-2 pl-10 pr-2 text-sm reset-base outline-none border-none rounded-lg bg-n-alpha-black2 dark:bg-n-glass-soft text-n-text-display"
        />
      </div>
      <div
