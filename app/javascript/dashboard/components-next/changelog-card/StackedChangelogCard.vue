...
<template>
  <div
    ...
    class="flex flex-col justify-between p-3 w-full rounded-lg border shadow-sm transition-all duration-200 border-n-border-glass-soft bg-n-card text-n-text-display"
    :class="{
  ...
  >
    <div>
      <h5
        ...
        class="mb-1 text-sm font-semibold line-clamp-1 text-n-text-display"
      >
        {{ card.meta_title }}
      </h5>
      <p
        :title="card.meta_description"
        class="mb-0 text-xs leading-relaxed text-n-text-body line-clamp-2"
      >
    ...
    <div
      ...
      class="block overflow-hidden my-3 rounded-md border border-n-border-glass-soft/40"
    >
      <img
