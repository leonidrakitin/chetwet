    ...
    <div class="grid gap-4 min-w-64">
      ...
      <div v-if="action" class="mb-2">
        <a
          ...
          target="_blank"
          class="w-full block bg-n-solid-3 px-4 py-2 rounded-lg text-sm text-center border border-n-border-hairline"
        >
          {{ action.label }}
        </a>
        <button
          v-else
          class="w-full bg-n-solid-3 px-4 py-2 rounded-lg text-sm text-center border border-n-border-hairline"
