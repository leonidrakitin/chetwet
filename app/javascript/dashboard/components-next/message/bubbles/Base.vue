...
const varaintBaseMap = {
  [MESSAGE_VARIANTS.AGENT]: 'bg-n-solid-blue text-n-text-display',
  [MESSAGE_VARIANTS.PRIVATE]:
    'bg-n-solid-amber text-n-amber-12 [&_.prosemirror-mention-node]:font-semibold',
  [MESSAGE_VARIANTS.USER]: 'bg-n-slate-4 text-n-text-display',
  [MESSAGE_VARIANTS.ACTIVITY]: 'bg-n-alpha-1 text-n-text-body text-sm',
  [MESSAGE_VARIANTS.BOT]: 'bg-n-solid-iris text-n-text-display',
  [MESSAGE_VARIANTS.TEMPLATE]: 'bg-n-solid-iris text-n-text-display',
