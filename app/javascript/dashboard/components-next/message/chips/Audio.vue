...
<template>
  ...
  <div
    v-bind="$attrs"
    class="rounded-xl w-full gap-2 p-1.5 bg-n-alpha-white flex flex-col items-center border border-n-border-hairline shadow-[0px_2px_8px_0px_rgba(94,94,94,0.06)]"
  >
