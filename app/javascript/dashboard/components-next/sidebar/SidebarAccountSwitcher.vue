...
<template>
  <DropdownContainer>
    <template #trigger="{ toggle, isOpen }">
      ...
      <button
        v-if="isCollapsed"
        class="grid flex-shrink-0 place-content-center p-2 rounded-xl cursor-pointer hover:bg-n-alpha-1"
      ...
      <button
        ...
        class="flex items-center gap-2 justify-between w-full rounded-xl px-3 py-2"
        :class="[
          isOpen && 'bg-n-alpha-1',
          showAccountSwitcher
