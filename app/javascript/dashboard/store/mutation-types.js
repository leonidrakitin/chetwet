export default {
  ...
  // Contact Segments
  SET_CONTACT_SEGMENT_UI_FLAG: 'SET_CONTACT_SEGMENT_UI_FLAG',
  SET_CONTACT_SEGMENTS: 'SET_CONTACT_SEGMENTS',
  ADD_CONTACT_SEGMENT: 'ADD_CONTACT_SEGMENT',
  EDIT_CONTACT_SEGMENT: 'EDIT_CONTACT_SEGMENT',
  DELETE_CONTACT_SEGMENT: 'DELETE_CONTACT_SEGMENT',
  SET_CONTACT_SEGMENT_CHANGE_LOGS: 'SET_CONTACT_SEGMENT_CHANGE_LOGS',
  SET_CONTACT_SEGMENT_STATISTICS: 'SET_CONTACT_SEGMENT_STATISTICS',
  SET_CONTACT_SEGMENT_DASHBOARD_STATS: 'SET_CONTACT_SEGMENT_DASHBOARD_STATS',

  // Segment Notification Types
  SET_SEGMENT_NOTIFICATION_TYPE_UI_FLAG: 'SET_SEGMENT_NOTIFICATION_TYPE_UI_FLAG',
  SET_SEGMENT_NOTIFICATION_TYPES: 'SET_SEGMENT_NOTIFICATION_TYPES',
  ADD_SEGMENT_NOTIFICATION_TYPE: 'ADD_SEGMENT_NOTIFICATION_TYPE',
  EDIT_SEGMENT_NOTIFICATION_TYPE: 'EDIT_SEGMENT_NOTIFICATION_TYPE',
  DELETE_SEGMENT_NOTIFICATION_TYPE: 'DELETE_SEGMENT_NOTIFICATION_TYPE',
