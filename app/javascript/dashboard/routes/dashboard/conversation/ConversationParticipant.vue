...
<template>
  <div class="relative">
    <div class="flex justify-between">
      <div class="flex justify-between w-full mb-1">
        <div>
          ...
          <p v-else class="m-0 text-sm text-n-text-body/60">
    ...
    <div class="flex items-center justify-between">
      ...
      />
      <p v-if="isUserWatching" class="m-0 text-sm text-n-text-body/60">
    ...
    <div
      ...
      class="border rounded-lg shadow-lg bg-n-alpha-3 absolute backdrop-blur-[100px] border-n-border-glass dark:border-n-border-glass p-2 z-[9999] box-border top-8 w-full"
    >
      <div class="flex items-center justify-between mb-1">
        <h4
          class="m-0 overflow-hidden text-sm whitespace-nowrap text-ellipsis text-n-text-display"
        >
