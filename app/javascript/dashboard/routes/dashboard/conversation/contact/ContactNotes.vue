...
<template>
  <div>
    ...
    <div
      ...
      class="flex items-center justify-center py-8 text-n-text-body"
    >
      <Spinner />
    </div>
    <div
    ...
    <p v-else class="px-6 py-6 text-sm leading-6 text-center text-n-text-body">
    ...
    >
      <div class="flex w-full flex-col gap-6 px-6 py-6">
        <h3 class="text-lg font-semibold text-n-text-display">
