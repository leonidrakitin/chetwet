  ...
  <div class="flex flex-col h-full overflow-auto p-6">
    ...
    <div class="flex flex-wrap items-center gap-3 mb-6">
      <input
        ...
        class="flex-1 min-w-[200px] rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 placeholder-slate-400 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200"
      />
      <select
        v-model="statusFilter"
        class="rounded-xl border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200"
      >
        <option value="">
