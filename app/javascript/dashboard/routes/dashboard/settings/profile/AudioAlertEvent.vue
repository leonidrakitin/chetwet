...
<template>
  <div>
    <label class="pb-1 text-sm font-medium leading-6 text-n-text-display">
      {{ label }}
    </label>
    <div class="grid gap-3 mt-2">
      ...
      >
        ...
        <label
          ...
          class="text-sm text-n-text-display font-normal"
        >
          {{
            $t(
      ...
      <div class="text-n-text-body text-sm font-medium mt-2">
        {{ $t(alertDescription) }}
      </div>
    </div>
  </div>
