...
<template>
  <div
    class="p-4 rounded-xl border border-n-border-glass-soft bg-n-glass-soft flex"
    :class="{
  ...
  >
    <div class="flex items-center justify-between gap-4 flex-1">
      <div class="flex-1 min-w-0">
        <h4 class="text-sm font-medium text-n-text-display">{{ title }}</h4>
        <p class="text-sm text-n-text-body mt-0.5">{{ description }}</p>
      </div>
    ...
    >
      <div class="flex-1 min-w-0">
        ...
        <p class="text-sm text-n-text-body mt-0.5">{{ modelDescription }}</p>
      </div>
