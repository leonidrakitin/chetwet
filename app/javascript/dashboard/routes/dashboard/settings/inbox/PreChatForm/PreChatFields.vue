      ...
      <tr>
        <td class="py-4 ltr:pl-4 ltr:pr-3 rtl:pl-3 rtl:pr-4 text-body-main">
          <Icon
            ...
            class="size-4 text-n-text-body mt-1 cursor-move"
          />
        </td>
        ...
        <td
          ...
          :class="{ 'text-n-text-body': !item['enabled'] }"
        >
          {{ item.name }}
        </td>
        <td
        ...
        >
          <input
            ...
            class="w-full text-sm !mb-0 px-2 py-1 border border-n-border-glass-soft rounded"
          />
        </td>
        <td
