...
const allSteps = computed(() => [
  ...
  t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS.STEP_2', atParams),
  t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS.STEP_3'),
  t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS.STEP_4', atParams),
]);

const hasBotSteps = computed(() => [
  t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS_HAS_BOT.STEP_1', atParams),
  t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS_HAS_BOT.STEP_2'),
  t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS_HAS_BOT.STEP_3'),
]);
...
const stepsTitle = computed(() =>
  hasBot.value
    ? t('INBOX_MGMT.ADD.MAX_CHANNEL.STEPS_HAS_BOT.TITLE')
