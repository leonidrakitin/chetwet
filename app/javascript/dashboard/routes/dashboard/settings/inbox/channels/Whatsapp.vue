...
import EvolutionApiWhatsapp from './EvolutionApiWhatsapp.vue';
...
const availableProviders = computed(() => [
  ...
  {
    key: PROVIDER_TYPES.EVOLUTION_API,
    title: t('INBOX_MGMT.ADD.WHATSAPP.PROVIDERS.EVOLUTION_API'),
    description: t('INBOX_MGMT.ADD.WHATSAPP.PROVIDERS.EVOLUTION_API_DESC'),
    icon: 'i-woot-whatsapp',
  },
]);
  ...
  <div class="overflow-auto col-span-6 p-6 w-full h-full">
    <div v-if="showProviderSelection">
      <div class="mb-10 text-left">
        <h1 class="mb-2 text-lg font-medium text-n-text-display">
    ...
    <div v-else-if="showConfiguration">
      <div class="px-6 py-5 rounded-2xl border border-n-border-glass-soft">
        ...
        >
          ...
          <div class="pt-6 mt-6 border-t border-n-border-glass-soft">
            <I18nT
        ...
        <EvolutionApiWhatsapp
          v-else-if="selectedProvider === PROVIDER_TYPES.EVOLUTION_API"
        />
