    ...
    <template #header>
      ...
      >
        <template v-if="attributes?.length" #count>
          <span class="text-body-main text-n-text-body truncate min-w-0">
    ...
    <template #body>
      <div class="flex flex-col gap-4">
        ...
        <div
          ...
          class="flex flex-col divide-y divide-n-border-glass-soft border-t border-n-border-glass-soft"
        >
          <AttributeListItem
        ...
        <p
          v-else
          class="flex-1 py-20 text-n-text-display flex items-center justify-center text-base"
        >
