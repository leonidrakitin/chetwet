          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col gap-1.5 items-start">
              ...
              <div class="flex items-center gap-2">
                ...
                <span
                  class="block w-fit text-body-main text-n-text-body relative"
                  :class="{
                    'hover:text-n-text-display group cursor-pointer':
                ...
                >
                  ...
                  <div
                    class="absolute ltr:left-0 rtl:right-0 z-10 hidden w-[300px] bg-n-alpha-3 backdrop-blur-[100px] rounded-xl outline outline-1 outline-n-border-glass-soft shadow-lg top-14 md:top-12"
