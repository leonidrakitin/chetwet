...
<template>
  <div
    class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 px-6 py-5 shadow outline-1 outline outline-n-border-glass-soft rounded-xl bg-n-glass-strong mt-4"
  >
    <div
    ...
    >
      ...
      <div class="mt-4 h-72">
        ...
        <div v-else class="flex items-center justify-center h-72">
          ...
          />
          <span v-else class="text-sm text-n-text-body/60">
