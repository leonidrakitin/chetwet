...
<template>
  <div
    class="px-6 py-4 mb-4 outline outline-n-border-glass-soft outline-1 bg-n-card rounded-xl"
  >
    <div class="flex">
      ...
      <div class="ml-3">
        <p class="mb-1 text-heading-2 text-n-text-display">
          {{
            $t('INTEGRATION_SETTINGS.SLACK.SELECT_CHANNEL.ATTENTION_REQUIRED')
          }}
        </p>
        <div class="mt-2 text-body-main text-n-text-body mb-3">
