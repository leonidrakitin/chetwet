...
<template>
  <div class="flex relative justify-end items-center resolve-actions">
    <ButtonGroup
      ...
      :class="
        !showOpenButton ? 'outline-n-border-glass-soft' : 'outline-transparent'
      "
    >
      <Button
    ...
    <div
      ...
      class="border rounded-lg shadow-lg border-n-border-glass dark:border-n-border-glass box-content p-2 w-fit z-10 bg-n-alpha-3 backdrop-blur-[100px] absolute block left-auto top-full mt-0.5 start-0 xl:start-auto xl:end-0 max-w-[12.5rem] min-w-[9.75rem] [&_ul>li]:mb-0"
    >
