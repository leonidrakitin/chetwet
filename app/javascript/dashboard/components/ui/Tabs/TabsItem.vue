...
<template>
  <li
    class="flex-shrink-0 my-0 mx-2 ltr:first:ml-0 rtl:first:mr-0 ltr:last:mr-0 rtl:last:ml-0 hover:text-n-text-display"
  >
    <a
      ...
      :class="[
        active
          ? 'text-n-text-display after:bg-n-accent-active after:opacity-100'
          : 'text-n-text-body after:bg-transparent after:opacity-0',
    ...
    >
      ...
      <div
        ...
        :class="[
          active
            ? 'bg-n-glass-strong text-n-text-display border border-n-border-glass-soft'
            : 'bg-n-glass-soft text-n-text-body',
        ]"
      >
        <span>
          {{ getItemCount }}
