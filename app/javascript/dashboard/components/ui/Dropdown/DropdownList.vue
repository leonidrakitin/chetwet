...
<template>
  <div
    class="absolute z-20 w-40 bg-n-glass-pane backdrop-blur-glass-card backdrop-saturate-glass border border-n-border-glass shadow-glass-soft rounded-card max-h-[400px]"
    @click.stop
  >
    <slot name="search">
      <DropdownSearch
