...
<template>
  <div class="relative flex-shrink-0 font-inter">
    ...
    <div
      ...
      class="flex absolute top-9 ltr:left-0 rtl:right-0 z-30 shadow-md select-none w-[880px] rounded-2xl bg-n-alpha-3 backdrop-blur-[100px] border-0 outline outline-1 outline-n-border-glass-soft"
    >
      <CalendarDateRange
        :selected-range="selectedRange"
      ...
      />
      <div
        class="flex flex-col w-[680px] ltr:border-l rtl:border-r border-n-border-glass"
      >
        <div class="flex justify-around h-fit">
          ...
          >
            ...
            />
            <div class="py-5 border-b border-n-border-glass">
              <div
                class="flex flex-col items-center gap-2 px-5 min-w-[340px] max-h-[352px]"
                :class="
                  calendar === START_CALENDAR &&
                  'ltr:border-r rtl:border-l border-n-border-glass'
                "
              >
                <CalendarYear
