...
<template>
  <button
    class="flex items-center w-auto h-9 p-1 transition-all border rounded-full bg-n-alpha-1 border-n-container group relative duration-300 ease-in-out z-0 active:scale-[0.995] active:duration-75"
