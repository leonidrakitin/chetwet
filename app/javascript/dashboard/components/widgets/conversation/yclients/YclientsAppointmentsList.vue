...
<template>
  <div class="px-4 py-2 text-n-text-display">
    <div
      ...
      class="flex flex-col gap-3 rounded-lg border border-n-border-glass-soft bg-n-alpha-1 p-3"
    >
    ...
    <div v-else>
      ...
      <div v-if="transactions.length" class="flex flex-col gap-2 pt-1">
        ...
        <div
          ...
          class="rounded-lg border border-n-border-glass-soft px-3 py-2"
        >
          <div class="flex items-start justify-between gap-3">
            ...
            <div class="text-right text-sm font-medium text-n-text-display">
              {{ transaction.total ?? transaction.amount }}
            </div>
          </div>
          <div class="pt-1 text-xs text-n-text-body/60">
