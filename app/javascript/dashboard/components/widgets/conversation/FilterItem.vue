...
<template>
  <select
    v-model="activeValue"
    class="w-32 h-6 py-0 pl-2 pr-6 mx-1 my-0 text-xs border border-solid bg-n-slate-3 dark:bg-n-solid-3 border-n-border-glass-soft dark:border-n-border-glass-soft text-n-text-display"
    @change="onTabChange()"
  >
