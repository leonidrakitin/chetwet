...
ActiveRecord::Schema[7.1].define(version: 2026_04_23_203133) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.decimal "feature_flags", precision: 80, default: "0", null: false
  ...
  create_table "captain_document_chunks", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "assistant_id"], name: "index_captain_document_chunks_on_account_id_and_assistant_id"
    t.index ["document_id", "position"], name: "index_captain_document_chunks_on_document_id_and_position", unique: true
    t.index ["document_id"], name: "index_captain_document_chunks_on_document_id"
    t.index ["embedding"], name: "index_captain_document_chunks_on_embedding", using: :ivfflat
    t.index ["searchable"], name: "index_captain_document_chunks_on_searchable", using: :gin
  end
  ...
  create_table "captain_documents", force: :cascade do |t|
    ...
    t.integer "status", default: 0, null: false
    t.jsonb "metadata", default: {}
    t.integer "chunking_status", default: 0, null: false
    t.integer "expected_chunk_count", default: 0, null: false
    t.integer "indexed_chunk_count", default: 0, null: false
    t.datetime "chunks_generated_at"
    t.text "last_chunk_error"
    t.index ["account_id"], name: "index_captain_documents_on_account_id"
    t.index ["assistant_id", "external_link"], name: "index_captain_documents_on_assistant_id_and_external_link", unique: true
    t.index ["assistant_id"], name: "index_captain_documents_on_assistant_id"
    t.index ["chunking_status"], name: "index_captain_documents_on_chunking_status"
    t.index ["chunks_generated_at"], name: "index_captain_documents_on_chunks_generated_at"
  ...
  create_table "captain_scenarios", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "required_slots", default: []
  ...
  create_table "channel_avito", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_channel_avito_on_account_id"
    t.index ["avito_user_id"], name: "index_channel_avito_on_avito_user_id"
    t.index ["client_id"], name: "index_channel_avito_on_client_id", unique: true
  end
  ...
  create_table "channel_vk", force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index ["copilot_thread_id"], name: "index_conversations_on_copilot_thread_id"
  ...
  create_table "copilot_threads", force: :cascade do |t|
    ...
    t.index ["user_id", "assistant_id", "source"], name: "index_copilot_threads_on_user_assistant_source"
  ...
  create_table "messages", id: :serial, force: :cascade do |t|
    ...
    t.index "((external_source_ids ->> 'vk_random_id'::text))", name: "index_messages_on_vk_random_id", where: "((external_source_ids ->> 'vk_random_id'::text) IS NOT NULL)"
  ...
  create_table "notification_template_deliveries", force: :cascade do |t|
  ...
  create_table "notification_templates", force: :cascade do |t|
    ...
    t.string "name", null: false
    t.text "description"
    t.string "template_type", default: "event", null: false
    t.string "event_type"
    t.boolean "enabled", default: true, null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "enabled"], name: "index_notification_templates_on_account_id_and_enabled"
    t.index ["account_id", "next_send_at"], name: "index_notification_templates_on_account_id_and_next_send_at"
    t.index ["account_id", "position"], name: "index_notification_templates_on_account_id_and_position"
    t.index ["account_id", "template_type"], name: "index_notification_templates_on_account_id_and_template_type"
    t.index ["account_id"], name: "index_notification_templates_on_account_id"
    t.index ["inbox_id"], name: "index_notification_templates_on_inbox_id"
    t.index ["yclients_integration_id"], name: "index_notification_templates_on_yclients_integration_id"
  end
  ...
  create_table "plans", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "captain_models", default: {}
  ...
  create_table "yclients_integrations", force: :cascade do |t|
    t.bigint "account_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.bigint "inbox_id"
    t.index ["account_id", "salon_id"], name: "index_yclients_integrations_on_account_id_and_salon_id", unique: true
    t.index ["account_id"], name: "index_yclients_integrations_on_account_id"
    t.index ["inbox_id"], name: "index_yclients_integrations_on_inbox_id"
  ...
  add_foreign_key "notification_template_deliveries", "notification_templates"
