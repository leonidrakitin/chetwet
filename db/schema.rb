...
ActiveRecord::Schema[7.1].define(version: 2026_02_11_100400) do
  ...
  create_table "contact_segment_memberships", force: :cascade do |t|
    t.bigint "contact_id", null: false
    t.bigint "contact_segment_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["contact_id"], name: "index_contact_segment_memberships_on_contact_id"
    t.index ["contact_segment_id", "contact_id"], name: "idx_segment_memberships_unique", unique: true
  end
  ...
  create_table "contact_segments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_contact_segments_on_account_id"
  end
